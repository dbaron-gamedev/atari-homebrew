...
; January 28, 2018
;
; This is the "Power Up" gym, I'm using it to test some power up ingredients.
; 

;===============================================================================
; References
;===============================================================================
; I'm using the "Collect Mini" tutorial by Darrell Spice Jr. as a baseline.
; http://atariage.com/forums/blog/148/entry-12538-collectmini-source-code/
;
...
PLAYER_COLOR    = $0E  ; red ; @TODO - This could be exploited for the death event
BOX_COLOR       = $0C   ; blue; @TODO - Could be changed dynamically to certain events
...
SaveY:  sty ObjectY,X           ; Store Y position with incrementation, this will prevent the ship from going thru the floor.
...
CheckUp:
        ...
        ldy ##(ARENA_HEIGHT - HUMAN_HEIGHT)     ; By substracting ARENA_HEIGHT with HUMAN_HEIGHT it will create a "bouncy" effect when hitting the cei
...
Kernel:    
        ...
        lda #$00
        sta COLUBK      ; STore  into TIA's background color register
...
DoDrawGrp1:                 ;   38 - from bcs DoDrawGrp1
        ...
        bne BackgroundLoop       ; 2 10 - 3 11 if taken        
        rts                 ; 6 16
